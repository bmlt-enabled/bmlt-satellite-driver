...
********************************************************************************************/
function u_test_apply_root_uri(
...
*   \returns A string. The XHTML to be displayed (Can be an error message).                 *
********************************************************************************************/
function u_test_get_standard_server_parameters(
    &$in_test_subject, ///< The object to be tested.
    $in_root_server_uri ///< A string. The root server URI.
) {
...
*   \returns A string. The XHTML to be displayed (Can be an error message).                 *
********************************************************************************************/
function u_test_server_root_uri(
    &$in_test_subject, ///< The object to be tested.
    $in_uri             ///< The base URI.
) {
...
*   \returns A string. The XHTML to be displayed.                                           *
********************************************************************************************/
function u_test_complex_search(
...
*   \returns A string. The XHTML to be displayed.                                           *
********************************************************************************************/
function u_test_serialized_search(
